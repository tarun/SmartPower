<%-- 
    Document   : requestPowerProfile
    Created on : May 6, 2008, 3:31:35 PM
    Author     : Tarun
--%>
...
<html>
    <head>
        ...
        <title>Smart Meter Request Power Profile</title>
    </head>
    <body>
             <%
	...
	java.lang.String powerRequirements = meterState.getCurrentPowerProfile();
	// TODO process result here
	java.lang.String result = port.requestPowerProfile(meterID, powerRequirements);
	out.println("Result = "+result);
        out.println("Smart Meter Status : "+smartMeter.processRequestProfileResponse(result));
    } catch (Exception ex) {
